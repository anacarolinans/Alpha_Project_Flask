...
def cadastro_aluno():
    if request.method == 'POST':
        ...
        if nome and idade and github and linkedin and mini_bio and foto and serie and cpf and uf and cidade:
...
def cadastro_professor():
    if request.method == 'POST':
        ...
        if nome and github and linkedin and bio and foto and email and telefone and idade:
            novo_professor = Professor(nome, github, linkedin, bio, foto, email, telefone, idade)
